 ...
 * @param[in,out] attrs    Attributes of the file after read. Only the
 *			   attributes set in attrs->mask will be retrieved.
 *
 * @return FSAL status.
 */
 ...
 *                            it did.
 * @param[in,out] info      more information about the data
 * @param[in,out] attrs     Attributes after write. Only the attributes set in
 *			    attrs->mask will be retrieved.
 *
 * @return FSAL status.
 */
 ...
 * @param[out] attrs            File attributes piggyback
 *
