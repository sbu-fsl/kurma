# cmake rule for GCC address-sanitizer (asan).
#
...
# uncomment this to use asan all the time
#SET(USE_ASAN ON)
...
if (USE_ASAN)
  ...
  set(ASAN_C_FLAGS "-fsanitize=address -O1 -fno-omit-frame-pointer")
  set(ASAN_CXX_FLAGS "-fsanitize=address -O1 -fno-omit-frame-pointer")

  set(ASAN_EXE_LINKER_FLAGS "-fsanitize=address -O1 -fno-omit-frame-pointer")
  set(ASAN_SHARED_LINKER_FLAGS "-fsanitize=address -O1 -fno-omit-frame-pointer")
