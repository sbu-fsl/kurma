...
bool init_export_root(struct gsh_export *export)
{
	...
	LogInfo(COMPONENT_EXPORT, "exp_root_cache_inode->obj_handle: %p",
		export->exp_root_cache_inode->obj_handle);
			   ...
			   cache_entry_t *entry, uint32_t flags)
{
	...
	LogInfo(COMPONENT_EXPORT, "root_entry = export->exp_root_cache_inode");
