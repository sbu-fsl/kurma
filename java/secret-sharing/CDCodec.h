...
class CDCodec{
    ...
    public:
         ...
         */
        int getShareSize(int secretSize);
         ...
         */
        int getAlignedSecretSize(int secretSize);
         ...
         * @return - a boolean value that indicates if the encoding succeeds
         */
        bool encoding(unsigned char *secretBuffer, int secretSize,
                      unsigned char *shareBuffer, int shareBufferSize, int *shareSize) {
            return encodingEx(secretBuffer, secretSize, secretSize, shareBuffer,
                              shareBufferSize, shareSize);
        }
         ...
         * @return - a boolean value that indicates if the encoding succeeds
         */
        bool encodingEx(unsigned char *secretBuffer, int secretBufferSize,
         ...
         * @return - a boolean value that indicates if the decoding succeeds
         */
        bool decoding(unsigned char *shareBuffer, int *kShareIDList,
                      int shareSize, int secretSize,
                      unsigned char *secretBuffer) {
            return decodingEx(shareBuffer, shareSize, kShareIDList, shareSize,
                              secretSize, secretBuffer, secretSize);
        }
         ...
         * @return - a boolean value that indicates if the decoding succeeds
         */
        bool decodingEx(unsigned char *shareBuffer, int shareBufferSize,
